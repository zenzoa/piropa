...
extern void draw_emote_sprite(uint8_t x, uint8_t y, uint8_t frame);

extern void setup_emote_sprites(void);
extern void draw_dirt_sprite(uint8_t x, uint8_t y);
extern void draw_bath_sprite(uint8_t x, uint8_t y, int8_t y_offset);
extern void draw_watering_sprite(uint8_t x, uint8_t y);
